...
class Crud_model extends CI_Model {
	...
	public function student_online_exam_status_update($loginStudentId, $quarter_id, $exam_id, $get_student_answers)
	{
		$checkexam_details = $this->db->get_where('online_exam_result', array('student_id' => $loginStudentId,'exam_id' => $exam_id))->row_array(); 
