...
<div class="row">
  ...
  $(document).ready(function() {
    ...
    function hitFunction() {
        $.ajax({
            url: 'hit_function.php',
            method: 'POST',
            data: { action: 'clock_stopped' },
            success: function(response) {
                alert('Function triggered. Server response: ' + response);
            }
        });
     }
   });
        ...
        function handleSubmit() {
           ...
           //alert(JSON.stringify(answers));
            ...
            $.ajax({
                url: url,
                method: 'POST',
                data: { quarter_id: getquarter_id, exam_id: getexam_id, student_answers: studentAns },
    ...
    $(document).ready(function() {
        ...
        if (examStartStatus === 'start') {
            ...
            $.ajax({
                url: url,
                method: 'POST',
                data: { quarter_id: getquarter_id, exam_id: getexam_id , student_answers: ""},
                success : function(response) {
                    console.log(response);
                    if (typeof response === 'string') {
                    response = JSON.parse(response);
